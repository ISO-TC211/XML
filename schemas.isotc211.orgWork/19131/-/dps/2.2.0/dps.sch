...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xml:lang="eng">
    <sch:ns prefix="dps" uri="https://schemas.isotc211.org/19131/-/dps/2.2"/>
    <sch:ns prefix="mdq" uri="https://schemas.isotc211.org/19157/-/mdq/1.2"/>
 
    <!--
    ISO 19124-1 base requirements for data product specifications
  -->
     <!-- 
